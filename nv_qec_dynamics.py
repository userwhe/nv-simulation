...
def build_nv_two_c13_lab_model(
    ...
    # The excited and singlet manifolds retain free nuclear precession in this
    # simplified model.  Their state-dependent hyperfine tensors are not known.
...
def make_nv_two_c13_model(
    ...
    incorrect static ``H_g1 - H_g0`` approximation.  Production simulations in
    this module use the lab-frame model and rotate operations/readout exactly.
    """
